...
describe() is used to label and organize your tests in the console, it() descibes a single test and contains a test function. 
    describe('<Component />', () => {
        *tests for Component 
     });
1. What is the point of `Test Driven Development`? What do you think about this approach?
TDD is used to systematically develop, ensuring all the functionality is implemented and that the code is easily testable. I see the merit in it, and I've never worked on large projects meant for production so it's probably more useful than I realize. For my personal projects it's overkill and slows down the process significantly.
